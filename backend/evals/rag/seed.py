...
#
# Usage (inside Docker):
#   docker compose exec -e MODELSERVER_TOKEN=<tok> -w /app backend python evals/rag/seed.py
#
# --endpoint is accepted for backward compatibility but currently unused.
#
...
async def main() -> None:
    ...
    async with httpx.AsyncClient(base_url=modelserver_url, timeout=300.0) as http_client:
